...
# Our objective is to __precisely predict Response__ so that life insurance applications can be scrutinized easily. Judging all the factors including AUC, __Decision Tree Clasifier model__ is more suitable for this datset.
